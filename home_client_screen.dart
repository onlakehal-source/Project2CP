...
import 'package:peeco/profil_commercant_client_screen.dart';
import 'package:peeco/offre_detail_screen.dart';
import 'package:peeco/profil_commercant_client_screen.dart';
  ...
  Widget _storeCard(NearbyStore s) {
    return GestureDetector(
      onTap: () => Navigator.pushNamed(
        ...
        arguments: DonneesCommercant(
          nom:            s.name,
          email:          '',
          adresse:        s.address,
          nbOffres:       s.offersCount,
          nbReservations: 0,
          note:           s.rating,
          revenus:        '',
          description:    'Découvrez les offres de \${s.name}.',
          logoAsset:      s.imageAsset,
        ),
      ),
      child: Container(
